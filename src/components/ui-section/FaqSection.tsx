          ...
          <Disclosure key={idx}>
            {({ open }) => (
              <div className="border border-gray-300 rounded-lg overflow-hidden">
                <Disclosure.Button className="flex justify-between items-center w-full px-5 py-4 text-left text-lg font-medium text-gray-800 hover:bg-gray-50 focus:outline-none">
                ...
                <Disclosure.Panel className="px-5 pb-5 text-gray-700">
                  {item.answer}
                </Disclosure.Panel>
              </div>
            )}
